...
- слежение за лицом и отправка углов поворота на M5Stack (ESP32) по Bluetooth для управления сервоприводами камеры; если устройство не найдено автоматически, появится окно поиска, где можно выбрать нужный модуль; при первом использовании потребуется выдать разрешение на Bluetooth
