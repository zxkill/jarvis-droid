...
- слежение за лицом и отправка углов поворота на M5Stack (ESP32) по Bluetooth для управления сервоприводами камеры; при первом использовании потребуется выдать разрешение на Bluetooth
